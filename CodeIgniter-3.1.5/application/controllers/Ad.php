...
{	
	...
	{
		$this->db->select('ADS.ad_id, item_description, views, ad_title, item_condition, item_price, post_date, user_name, image_location, address, city, province, USERS.id, USERS.user_name');
		$this->db->from('ADS');
